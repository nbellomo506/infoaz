...
from .views import CostoSmaltimentoViewSet,get_costi_smaltimento,update_compiling_section,add_costi_smaltimento,update_costi_smaltimento,del_costi_smaltimento,getEfficienzaQualitaDifferenziata,saveEfficienzaQualitaDifferenziata
...
urlpatterns = [
        ...
        path('update_compiling_section', update_compiling_section),
